...
Dans ce challenge, on doit déchiffrer un texte chiffré à partir de ce script python : <a href="/writeups/StarHackademINT2018/Zip-Bruteforce/flag.zip">flag.zip</a> fourni sur le site du challenge. <br />
